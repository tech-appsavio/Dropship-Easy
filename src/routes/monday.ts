...
router.post('/api/monday/get_columns_options', InvocableActions.getColumnsDropdownOptions);
router.get('/api/monday/get_columns_options', InvocableActions.getColumnsDropdownOptions);
