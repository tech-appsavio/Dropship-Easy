...
export const OrderManifestGeneration = ({ selectedOrderIds, onBack }: { selectedOrderIds: string[], onBack: () => void }) => {
    ...
    const fetchShopDetails = async () => {
        ...
        return {
            logo: getCol(SHOPS_MANIFEST_COLUMN_IDS_MAP.LOGO)?.files?.[0]?.public_url || "",
